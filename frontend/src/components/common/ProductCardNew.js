...
const CompareButton = styled.button`
  ...
  svg {
    color: ${props => props.isComparing ? '#FF5722' : '#333'};
  }
`;
...
const FavoriteButton = styled.button`
  ...
  svg {
    color: ${props => props.isFavorite ? '#FF5722' : '#333'};
    fill: ${props => props.isFavorite ? '#FF5722' : 'none'};
  }
`;
  ...
  return (
    <CardContainer>
      <ImageContainer>
        ...
        <CompareButton
          onClick={() => onToggleComparison && onToggleComparison(product)}
