...
/**
 * Kafka configuration for the shared kernel.
 * This configuration sets up producers, consumers, and error handling.
 */
@Configuration
@EnableKafka
public class KafkaConfiguration {
    ...
    public ConcurrentKafkaListenerContainerFactory<String, String> kafkaListenerContainerFactory(
        ...
        // Add custom logic to send to DLQ after retries are exhausted
